 ...
 */
public class WFSPointStationLookup implements StationLookup {

    private static final Logger LOG = LoggerFactory.getLogger(
            WFSPointStationLookup.class);
    private final LinkedHashMap<String, Station> stationLookupTable = Maps.newLinkedHashMap();

    public WFSPointStationLookup(RunMetadata meta) throws IOException, XMLStreamException {
        this(meta.getWfsUrl(), meta.getLayerName(), meta.getCommonAttribute());
    }
    
    public WFSPointStationLookup(String wfsUrl, String typeName, String nameAttr) throws
