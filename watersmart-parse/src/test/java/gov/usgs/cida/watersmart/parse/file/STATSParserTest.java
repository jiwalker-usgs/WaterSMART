...
public class STATSParserTest {
    ...
    public void testNetCDF() throws IOException, XMLStreamException {
		...
		try {
			...
			/**
			 * location="/var/folders/nt/486jzvcj5d3g9bgwg5x1kv_c0000gp/T/stats/STATS.nc"
			 */			
			assertEquals(dataFile.getLocation(), "/var/folders/nt/486jzvcj5d3g9bgwg5x1kv_c0000gp/T/stats/STATS.nc");
