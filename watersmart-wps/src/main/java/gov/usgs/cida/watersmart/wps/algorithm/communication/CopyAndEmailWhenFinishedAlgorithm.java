 ...
 */
public class CopyAndEmailWhenFinishedAlgorithm extends AbstractSelfDescribingAlgorithm {

    static org.slf4j.Logger log = LoggerFactory.getLogger(CopyAndEmailWhenFinishedAlgorithm.class);
