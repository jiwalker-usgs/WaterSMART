...
#model_url="http://cida-wiwsc-gdp1qa.er.usgs.gov:8080/thredds/sos/watersmart/afinch/afinch-Scenario-0.1.nc"
#modsites='"02177000","02178400"'
#modprop="MEAN"
...
statsout<-data.frame(t(a),nsev,nselogv,rmsev,yv,ma1v,ma2v,ma3v,ma5v,ma12v,ma13v,ma14v,ma15v,ma16v,ma17v,ma18v,ma19v,ma20v,ma21v,ma22v,ma23v,
                     ...
                     ma1v2,ma2v2,ma3v2,ma5v2,ma12v2,ma13v2,ma14v2,ma15v2,ma16v2,ma17v2,ma18v2,ma19v2,ma20v2,ma21v2,ma22v2,ma23v2,
                     ma24v2,ma25v2,ma26v2,ma27v2,ma28v2,ma29v2,ma30v2,ma31v2,ma32v2,ma33v2,ma34v2,ma35v2,ma37v2,ma39v2,ma40v2,ml13v2,ml14v2,mh14v2,mh16v2,
                     mh26v2,ml17v2,ml18v2,fl1v2,fl2v2,fh1v2,fh2v2,fh3v2,fh4v2,dl1v2,dl2v2,dl4v2,dl5v2,dl6v2,dl9v2,dl10v2,dl18v2,dh5v2,dh10v2,tl1v2,tl2v2,th1v2,th2v2,ra1v2,ra3v2,ra4v2,
                     ma1vdiff,ma2vdiff,ma3vdiff,ma5vdiff,ma12vdiff,ma13vdiff,ma14vdiff,ma15vdiff,ma16vdiff,ma17vdiff,ma18vdiff,ma19vdiff,ma20vdiff,ma21vdiff,ma22vdiff,ma23vdiff,
                     ma24vdiff,ma25vdiff,ma26vdiff,ma27vdiff,ma28vdiff,ma29vdiff,ma30vdiff,ma31vdiff,ma32vdiff,ma33vdiff,ma34vdiff,ma35vdiff,ma37vdiff,ma39vdiff,ma40vdiff,ml13vdiff,ml14vdiff,mh14vdiff,mh16vdiff,
                     mh26vdiff,ml17vdiff,ml18vdiff,fl1vdiff,fl2vdiff,fh1vdiff,fh2vdiff,fh3vdiff,fh4vdiff,dl1vdiff,dl2vdiff,dl4vdiff,dl5vdiff,dl6vdiff,dl9vdiff,dl10vdiff,dl18vdiff,dh5vdiff,dh10vdiff,tl1vdiff,tl2vdiff,th1vdiff,th2vdiff,ra1vdiff,ra3vdiff,ra4vdiff)
colnames(statsout)<-c('site_no','nse','nselog','rmse','min_date','ma1_mean_disc','ma2_median_disc','ma3_mean_annual_var','ma5_skew','ma12_jan_mean','ma13_feb_mean','ma14_mar_mean','ma15_apr_mean',
                      ...
                      'th2_max_julian_var','ra1_rise_rate','ra3_fall_rate','ra4_fall_rate_var','ma1_mean_disc_mod','ma2_median_disc_mod','ma3_mean_annual_var_mod','ma5_skew_mod','ma12_jan_mean_mod','ma13_feb_mean_mod','ma14_mar_mean_mod','ma15_apr_mean_mod',
                      'ma16_may_mean_mod','ma17_june_mean_mod','ma18_july_mean_mod','ma19_aug_mean_mod','ma20_sep_mean_mod','ma21_oct_mean_mod','ma22_nov_mean_mod','ma23_dec_mean_mod','ma24_jan_var_mod','ma25_feb_var_mod',
                      'ma26_mar_var_mod','ma27_apr_var_mod','ma28_may_var_mod','ma29_jun_var_mod','ma30_july_var_mod','ma31_aug_var_mod','ma32_sep_var_mod','ma33_oct_var_mod','ma34_nov_var_mod','ma35_dec_var_mod',
                      'ma37_var_across_months_mod','ma39_monthly_std_dev_mod','ma40_monthly_skewness_mod','ml13_min_monthly_var_mod','ml14_min_annual_flow_mod','mh14_med_annual_max_mod',
                      'mh16_high_flow_index_mod','mh26_high_peak_flow_mod','ml17_base_flow_mod','ml18_base_flow_var_mod','fl1_low_flood_pulse_mod','fl2_low_pulse_var_mod',
                      'fh1_high_pulse_count_mod','fh2_high_pulse_var_mod','fh3_high_pulse_count_three_mod','fh4_high_pulse_count_seven_mod','dl1_min_daily_flow_mod',
                      'dl2_min_3_day_avg_mod','dl4_min_30_day_avg_mod','dl5_min_90_day_avg_mod','dl6_min_flow_var_mod','dl9_min_30_day_var_mod','dl10_min_90_day_var_mod',
                      'dl18_zero_flow_days_mod','dh5_max_90_day_avg_mod','dh10_max_90_day_var_mod','tl1_min_flow_julian_day_mod','tl2_min_julian_var_mod','th1_max_flow_julian_day_mod',
                      'th2_max_julian_var_mod','ra1_rise_rate_mod','ra3_fall_rate_mod','ra4_fall_rate_var_mod','ma1_mean_disc_diff','ma2_median_disc_diff','ma3_mean_annual_var_diff','ma5_skew_diff','ma12_jan_mean_diff','ma13_feb_mean_diff','ma14_mar_mean_diff','ma15_apr_mean_diff',
                      'ma16_may_mean_diff','ma17_june_mean_diff','ma18_july_mean_diff','ma19_aug_mean_diff','ma20_sep_mean_diff','ma21_oct_mean_diff','ma22_nov_mean_diff','ma23_dec_mean_diff','ma24_jan_var_diff','ma25_feb_var_diff',
                      'ma26_mar_var_diff','ma27_apr_var_diff','ma28_may_var_diff','ma29_jun_var_diff','ma30_july_var_diff','ma31_aug_var_diff','ma32_sep_var_diff','ma33_oct_var_diff','ma34_nov_var_diff','ma35_dec_var_diff',
                      'ma37_var_across_months_diff','ma39_monthly_std_dev_diff','ma40_monthly_skewness_diff','ml13_min_monthly_var_diff','ml14_min_annual_flow_diff','mh14_med_annual_max_diff',
                      'mh16_high_flow_index_diff','mh26_high_peak_flow_diff','ml17_base_flow_diff','ml18_base_flow_var_diff','fl1_low_flood_pulse_diff','fl2_low_pulse_var_diff',
                      'fh1_high_pulse_count_diff','fh2_high_pulse_var_diff','fh3_high_pulse_count_three_diff','fh4_high_pulse_count_seven_diff','dl1_min_daily_flow_diff',
                      'dl2_min_3_day_avg_diff','dl4_min_30_day_avg_diff','dl5_min_90_day_avg_diff','dl6_min_flow_var_diff','dl9_min_30_day_var_diff','dl10_min_90_day_var_diff',
                      'dl18_zero_flow_days_diff','dh5_max_90_day_avg_diff','dh10_max_90_day_var_diff','tl1_min_flow_julian_day_diff','tl2_min_julian_var_diff','th1_max_flow_julian_day_diff',
                      'th2_max_julian_var_diff','ra1_rise_rate_diff','ra3_fall_rate_diff','ra4_fall_rate_var_diff')
output="output.txt"
