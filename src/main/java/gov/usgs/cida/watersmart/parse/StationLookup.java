...
public class StationLookup {
    ...
    public StationLookup(String wfsUrl, String typeName, String nameAttr) throws IOException, XMLStreamException {
        // might be better way to do this call
            ...
            while (reader.hasNext()) {
                ...
                if (code == START_ELEMENT
                    ...
                    stationId = null;
                         ...
                         && lon != Float.NaN
                         && stationId != null) {
                    stationLookupTable.put(stationId, new Station(lat, lon, stationId, index));
                    index++;
                }
